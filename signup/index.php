   ...
   <!-- bootstrap -->
    ...
    <style>
      button.btn.text-white:hover{
        ...
        border: 1.2px #607d8b00 solid !important;
        background: linear-gradient(261deg,rgb(40 107 228) 0%,rgb(36 146 224) 100%) !important;
      }
        ...
        <div class="col-md-6 bg-light rounded py-5 px-5 " style="box-shadow: 0px 0px 20px 0px #676767;">
                ...
                <form action=""method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-6">
                      <div class="mb-3">
                        <label for="role" class="form-label">Choose One</label>
                    ...
                    <div class="mb-3">
                      ...
                      <input value="<?php if(empty($_POST['email'])){ echo "";} else{echo $_POST['email'];} ?>" id="email" placeholder="Email" name="email"   type="email" class=" form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>

                    <div class="mb-3">
                      <label for="phone" class="form-label">Phone</label>
                      <span class="text-danger"><?php echo $phoneError; ?></span>
                      <input value="<?php if(empty($_POST['phone'])){ echo "";} else{echo $_POST['phone'];} ?>" id="phone"  placeholder="Phone" name="phone"   type="tel" class="form-control" id="exampleInputPhone">
                    </div>
                    <div class="mb-3">
                      <label for="address" class="form-label">Address</label>
                      <span class="text-danger"><?php echo $addressError; ?></span>
                      <input value="<?php if(empty($_POST['address'])){ echo "";} else{echo $_POST['address'];} ?>" id="address"  placeholder="Address" name="address"   type="text" class=" form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    ...
                    <div class="col-6"><div class="mb-3">
                      ...
                      <input value="<?php if(empty($_POST['name'])){ echo "";} else{echo $_POST['name'];} ?>" id="name" placeholder="Name" name="name"   type="text" class=" form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    ...
                    <div class="mb-3">
                      ...
                      <input value="<?php if(empty($_POST['pass'])){ echo "";} else{echo $_POST['pass'];} ?>" id="password"   placeholder="Password" name="pass"   type="password" class=" form-control" id="exampleInputPassword1">
                    </div>
                    ...
                    <div class="mb-3">
                      ...
                      <div class='input-group date' id='datetimepicker1'>
                        <input value="<?php if(empty($_POST['dob'])){ echo "";} else{echo $_POST['dob'];} ?>" id="dob" type='date' name="dob" class="form-control" />
                  ...
                  <div class="row">
                    ...
                    <div class="col-6 mt-5">
                      ...
                      background: linear-gradient(261deg,rgb(0 75 212) 0%,rgb(36 146 224) 100%);"
                       type="submit" name="submit" class="btn text-white">Create Account</button>
                    </div>

                    <div class="col-6 mt-5">
                      <a href="../signin" class=" text-muted" style="text-decoration: none;">Already have an account?</a>
                    </div>
