                ...
                <form action="signup.php"method="post">
                  <div class="row">
                    ...
                    <div class="mb-3">
                      ...
                      <input placeholder="Email" name="email"   type="text" class=" form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                      
                    </div>
                    <div class="mb-3">
                      <label for="" class="form-label">Phone</label>
                      <input placeholder="Phone" name="phone"   type="tel" class="form-control" id="exampleInputPhone">
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Address</label>
                      <input placeholder="Address" name="address"   type="text" class=" form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    ...
                    <div class="mb-3">
                      ...
                      <input placeholder="Password" name="pass"   type="password" class=" form-control" id="exampleInputPassword1">
                    </div>
